...
function validateAndSubmitProduct() {
    ...
    var giaGiamInput = form.elements['PhanTramGiam'];
    ...
    var giaGiamValidationError = document.querySelector('[data-valmsg-for="PhanTramGiam"]');
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.exists) {
                ...
                formData.set("PhanTramGiam", giaGiamDecimal.toString());
